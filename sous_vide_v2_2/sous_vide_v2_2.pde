...
if (millis() - last_check > INTERVAL) 
 {    
	...
	if( current > 60) { // convert to hours if bigger than an hour
		current = current / 60;
		}
    Serial.print(":");
  ...
  Serial.println(temp1);
	...
	if ( trig_minutes ==0 && temp1 < TEMP_LOW -10) { //give warning, food went bellow 10 degrees of cooking temp
	  lcd.setCursor(0,0);
      lcd.print("WARN: T-10 cook");
	}
